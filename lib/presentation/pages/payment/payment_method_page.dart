                ...
                children: [
                  ...
                  Obx(() => GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: controller.selectedPaymentType.value == 'card'
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: controller.selectedPaymentType.value == 'card'
                                  ? Center(
                                      child: Container(
                                        width: 12.w,
                                        height: 12.w,
                  ...
                  Obx(() => GestureDetector(
                    ...
                    child: Container(
                      padding: EdgeInsets.all(16.w),
                      decoration: BoxDecoration(
                        color: controller.selectedPaymentType.value == 'digital'
                          ? const Color(0xFFF3F0FF)
                          : Colors.white,
                        borderRadius: BorderRadius.circular(12.r),
                        border: Border.all(
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: controller.selectedPaymentType.value == 'digital'
                                  ? Center(
                                      child: Container(
                                        width: 12.w,
                                        height: 12.w,
