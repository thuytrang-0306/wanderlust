...
class CreatePostController extends GetxController {
  ...
  Future<void> pickImages() async {
    try {
      ...
      AppSnackbar.showError(title: 'Lỗi', message: 'Không thể chọn ảnh');
    }
  }
  ...
  Future<void> sharePost() async {
    ...
    if (selectedImages.isEmpty) {
      AppSnackbar.showWarning(title: 'Thiếu ảnh', message: 'Vui lòng thêm ít nhất một ảnh');
      return;
    }
    ...
    try {
      ...
      AppSnackbar.showError(title: 'Lỗi', message: 'Đã xảy ra lỗi: ${e.toString()}');
    } finally {
